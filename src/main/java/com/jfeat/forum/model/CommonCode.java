...
public enum CommonCode implements ResultCode{
    ...
    LOGOUTSUCCESS(true,202,"退出成功"),
    UPLOADFILEFAIL(false,606,"上传失败，最多一次上传10张"),
    UPLOADFAIL(false,606,"文件上传失败"),
    UPLOADSUCCESS(true,600,"上传成功"),
    ...
    NOTLOGIN(false,100,"请登陆后操作"),
    SERVER_ERROR(false,99999,"抱歉，系统繁忙，请稍后重试！"),
    READ_FILE_ERROR(false,99999,"敏感词库文件读取失败！");
